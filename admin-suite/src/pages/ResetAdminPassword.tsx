...
export default function ResetAdminPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/developer/reset-admin-password`,
        {
          method: "POST",
          headers: {
      ...
      if (!response.ok) {
        throw new Error(
          data.detail || "Failed to reset admin password"
        );
      }
  ...
  return (
    <div className="justify-center font-sans">
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 bg-white/70 backdrop-blur-2xl border border-white/90 rounded-[2.5rem] shadow-[0_20px_80px_rgba(59,130,246,0.15)] overflow-hidden">

        {/* Left Panel */}
        <div className="relative p-8 lg:p-10 flex flex-col items-center justify-center border-b lg:border-b-0 lg:border-r border-blue-100 bg-gradient-to-br from-blue-100/50 via-sky-50 to-blue-200/40 overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <p className="text-blue-700/80 text-sm max-w-sm leading-relaxed font-medium">
              Initialize a master credential reset for the Administrator account.
            </p>

            <div className="mt-7 flex gap-5 text-blue-600">

              <div className="p-3 rounded-2xl bg-white border border-blue-100 shadow-[0_10px_25px_rgba(59,130,246,0.1)] hover:scale-110 transition-transform">
        ...
        {/* Right Panel */}
        <div className="p-8 lg:p-10 flex flex-col justify-center bg-white/40 relative">
          ...
          <div className="mb-5 text-center lg:text-left">
            ...
            <p className="text-blue-700/70 text-xs font-medium">
              Assign a new master identity key for the system administrator.
            </p>
          </div>

          <form
            onSubmit={handleSubmit}
            className="space-y-5 w-full max-w-md mx-auto lg:mx-0 mt-2"
          >
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] font-bold tracking-widest text-blue-700 uppercase ml-2 flex items-center gap-1.5">
                  <KeyRound size={12} /> New Admin Key
                </label>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-white/80 border border-blue-200/80 text-blue-950 rounded-full pl-10 pr-12 py-3 focus:outline-none focus:ring-4 focus:ring-sky-500/20 focus:border-sky-500 transition-all duration-300 placeholder:text-blue-300 shadow-sm text-sm"
                    required
                  />
              ...
              <div className="bg-blue-50/50 rounded-xl p-3 border border-blue-100/50 space-y-1.5 ml-2 mr-2">
                <CriteriaItem
                  met={hasLength}
            ...
            <div className="space-y-1.5">
              ...
              <label className="text-[10px] font-bold tracking-widest text-blue-700 uppercase ml-2 flex items-center gap-1.5">
                <ShieldCheck size={12} /> Verify New Admin Key
              </label>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  } text-blue-950 rounded-full pl-10 pr-12 py-3 focus:outline-none focus:ring-4 transition-all duration-300 placeholder:text-blue-300 shadow-sm text-sm`}
                  required
                />
            ...
            {/* Locked/Unlocked Submit Button */}
            <button
              type="submit"
              disabled={!isFormValid || loading}
              className={`w-full mt-6 px-6 py-3.5 rounded-full transition-all duration-500 flex justify-center items-center gap-2 uppercase text-xs font-bold tracking-wide
                ${
                  isFormValid
