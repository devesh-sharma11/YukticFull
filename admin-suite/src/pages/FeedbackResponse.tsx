...
//   if (!window.confirm("Delete ALL feedback responses?")) return;
...
// const deleteWeeklyFeedback = async () => {
//   if (!window.confirm("Delete last 7 days feedback?")) return;

//   await fetch(
//     `${import.meta.env.VITE_API_URL}/feedback/week`,
//     {
//       method: "DELETE",
//     }
//   );
...
// const deleteMonthlyFeedback = async () => {
//   if (!window.confirm("Delete last 30 days feedback?")) return;

//   await fetch(
//     `${import.meta.env.VITE_API_URL}/feedback/month`,
//     {
//       method: "DELETE",
//     }
//   );
...
//   if (loading) {
//     return (
//       <div className="p-10 text-center text-lg font-semibold text-[#56685E]">
//         Loading Feedback...
//       </div>
//     );
//   }
...
//       <h1 className="text-[40px] md:text-[52px] font-light text-[#0F2318] mb-12">
//         Feedback Responses
//       </h1>
...
//   <button
//     onClick={deleteWeeklyFeedback}
//     className="px-5 py-3 rounded-xl bg-orange-500 text-white font-semibold hover:bg-orange-600"
//   >
//     Delete Weekly
//   </button>

//   <button
//     onClick={deleteMonthlyFeedback}
//     className="px-5 py-3 rounded-xl bg-yellow-500 text-white font-semibold hover:bg-yellow-600"
//   >
//     Delete Monthly
//   </button>
...
//       {feedbacks.length === 0 && (
//         <div className="text-center text-[#56685E] bg-white rounded-2xl border border-[#D7E7DF] p-10">
...
//         {feedbacks.map((item) => {
//           // Determine the best text to show as a preview
...
//             <div
//               key={item._id}
//               className="flex flex-col overflow-hidden rounded-[20px] border border-[#E5E7EB] bg-white shadow-sm hover:shadow-xl transition-all duration-300"
//             >
//               {/* Top Accent Bar */}
//               <div className="h-[8px] bg-[#2A6049] flex-shrink-0" />
...
//                     {item.projectName && (
//                       <div className="mb-1"><span className="font-bold text-[#2A6049]">Project:</span> {item.projectName}</div>
//                     )}
//                     {item.services && item.services.length > 0 && (
//                       <div className="truncate"><span className="font-bold text-[#2A6049]">Services:</span> {item.services.join(", ")}</div>
//                     )}
//                   </div>
//                 )}
...
//   <button
//     onClick={() => deleteSingleFeedback(item._id)}
...
//         await fetch(`${import.meta.env.VITE_API_URL}/feedback/${deleteAction.id}`, { method: "DELETE" });
//         setFeedbacks((prev) => prev.filter((item) => item._id !== deleteAction.id));
//       } else {
//         let endpoint = "";
//         if (deleteAction.type === "ALL") endpoint = "/feedback";
//         if (deleteAction.type === "WEEKLY") endpoint = "/feedback/week";
//         if (deleteAction.type === "MONTHLY") endpoint = "/feedback/month";

//         await fetch(`${import.meta.env.VITE_API_URL}${endpoint}`, { method: "DELETE" });
//         reloadFeedbacks();
//       }
//     } catch (error) {
...
//       case "WEEKLY":
//         return {
//           title: "Delete Weekly Feedback?",
//           text: "Are you sure you want to delete all feedback from the last 7 days? This action cannot be undone.",
//         };
//       case "MONTHLY":
//         return {
//           title: "Delete Monthly Feedback?",
//           text: "Are you sure you want to delete all feedback from the last 30 days? This action cannot be undone.",
//         };
//       case "ALL":
//         return {
...
//           <button
//             onClick={() => setDeleteAction({ type: "WEEKLY" })}
//             className="px-5 py-3 rounded-xl bg-orange-500 text-white font-semibold hover:bg-orange-600"
//           >
//             Delete Weekly
//           </button>
...
//           <button
//             onClick={() => setDeleteAction({ type: "MONTHLY" })}
//             className="px-5 py-3 rounded-xl bg-yellow-500 text-white font-semibold hover:bg-yellow-600"
//           >
//             Delete Monthly
//           </button>
