...
const services = [
  {
    id: "founder-led-accountability",
    label: "FOUNDER-LED ACCOUNTABILITY",
    title: "Leadership stays close to the work.",
    bgImage: courageImg,

    context:
      "As a founder-led company, we believe accountability should never get lost behind layers of management.",

    whatWeDo:
      "We stay closely involved with our clients, understand the challenges behind the requirement, and remain accessible throughout the engagement — from building the right team to delivering the expected outcome.",

    approachTitle: "ACCOUNTABILITY IN ACTION",

    approach: [
      "Direct access to leadership when it matters",
      "Faster decisions with fewer unnecessary layers",
      "Clear ownership of commitments",
      "Transparent communication on progress and challenges",
      "Leadership involvement when an engagement needs attention",
    ],
...

  {
    ...
    context:
      "We believe good execution starts with asking the right questions, challenging assumptions, and understanding the problem in its entirety.",

    whatWeDo:
      "We bring a structured, logical approach to technology and delivery — whether we are solving a technical problem, building a team, or taking up a complete project.",

    approachTitle: "EXECUTION IN ACTION",

    approach: [
      "Requirements understood before resources are proposed",
      "Practical solutions over unnecessary complexity",
      "Decisions based on facts and context",
      "Clear priorities and defined ownership",
      "Continuous assessment as requirements evolve",
    ],
...

  {
    id: "flexible-engagement",
    label: "FLEXIBLE ENGAGEMENT",
    title: "The engagement should fit the need — not the other way around.",
    bgImage: respectImg,

    context:
      "Every organization has different priorities, constraints and stages of growth. A rigid engagement model rarely works for everyone.",

    whatWeDo:
      "We offer staff augmentation, dedicated teams and fixed-cost project delivery, with the flexibility to shape the engagement around the client's actual requirement.",

    approachTitle: "FLEXIBILITY IN ACTION",

    approach: [
      "Scale teams up or down as requirements change",
      "Build capabilities around specific technology needs",
      "Adapt engagement models as projects evolve",
      "Support both short-term requirements and long-term teams",
      "Avoid forcing clients into a predefined model",
    ],
...

  {
    id: "strong-technology-network",
    label: "STRONG TECHNOLOGY NETWORK",
    title: "The right capability, when you need it.",
    bgImage: courageImg,

    context:
      "Finding the right technology professionals can be as challenging as the technology itself. Our network helps us approach this challenge with greater flexibility.",

    whatWeDo:
      "We leverage our technology network and industry experience to identify, build and scale teams around specific client requirements rather than limiting ourselves to a fixed pool of resources.",

    approachTitle: "CAPABILITY IN ACTION",

    approach: [
      "Access to professionals across multiple technologies",
      "Teams built around the actual requirement",
      "Technology-specific sourcing and evaluation",
      "Ability to build and scale teams as needs evolve",
      "Focus on fit, capability and delivery — not just availability",
    ],
            ...
            >
              ...
              <div className="ykc2026-heading">
                ...
                <div className="ykc2026-heading-copy">
                  ...
                  {/* SERVICE NAME */}
                  <div className="ykc2026-detail-label">
              ...
              <div className="ykc2026-columns">
                ...
                <div className="ykc2026-what">
                  ...
                  <div className="ykc2026-what-content">

                    <div className="ykc2026-what-icon">
                      <WhatWeDoIcon />
                    </div>
